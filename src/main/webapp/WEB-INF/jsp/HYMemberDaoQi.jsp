...
<head>
    ...
    <script>
        $(function () {
            ...
            $('#dg').bootstrapTable({
                url: '${pageContext.request.contextPath}/menber/query2',
                method: 'post',
                ...
                columns: [
                    ...
                    {field: 'membertype.typeName', title: '卡类型'},
        ...
        function search() {
            ...
            $.post("${pageContext.request.contextPath}/menber/query2", {
        ...
        function tianjia() {
            ...
            var data = $('#data').val();
            var age = $('#age').val();
            $.post("${pageContext.request.contextPath}/menber/insert", {
                "memberName": name,
                "memberPhone": phone,
                "memberSex": sex,
                "birthday": srdata,
                "Membertypes.typeId": optype,
                "nenberDate": data,
                "memberAge": age
            }, function (releset) {
                if (releset != null) {
        ...
        function upd() {
            ...
            $.post("${pageContext.request.contextPath}/ktype/query2", {"xztype": optype}, function (releset) {
                ...
                $.post("${pageContext.request.contextPath}/menber/update", {
                    "memberId": id, "memberName": name, "memberPhone": phone,
                    "memberSex": sex, "birthday": srdata, "membertypes.typeId": optype,
                    "nenberDate": data, "memberAge": age, "Memberxufei": rq
                }, function (releset) {
                    $("#dg").bootstrapTable('load', releset);
                    if (releset != null) {
                        $("#dg").bootstrapTable('load', releset);
    ...
    <div class="panel-body">
        <form class="form-inline">
            ...
            <button type="button" id="download" style="margin-left:20px;" id="btn_download" class="btn btn-primary"
                    onClick="$('#dg').tableExport({ type: 'excel', escape: 'false' })">数据导出
            </button>
