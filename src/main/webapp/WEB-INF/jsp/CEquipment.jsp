...
<head>
    ...
    <script type="text/javascript">
        ...
        function chaxun() {
            ...
            $.post("${pageContext.request.contextPath}/qc/query", {
        ...
        function tianjia() {
            ...
            $.post("${pageContext.request.contextPath}/qc/insert", {
                "eqName": name,
                "eqText": text1
            }, function (releset) {
                if (releset != null) {
    ...
    <div class="panel-body">
        <form class="form-inline">
            ...
            <button type="button" class="btn btn-default" style="float: right; margin-top: 20px" data-toggle="modal"
                    onclick="insert()"><span class="glyphicon glyphicon-plus"></span>添加器材
            </button>
        </form>
    </div>
